 ...
 * @codeCoverageIgnore
 *
 * @internal PHP5.x backport of kornrunner/php-keccak
 */
class Keccak
{
    ...
    private static function keccakx($in_raw, $capacity, $outputlength, $suffix, $raw_output) {
        return self::$x64
    ...
    public static function hash($in, $mdlen, $raw_output = false) {
        ...
        return self::keccakx($in, $mdlen, $mdlen, self::LFSR, $raw_output);
    }
    ...
    public static function shake($in, $security_level, $outlen, $raw_output = false) {
        ...
        return self::keccakx($in, $security_level, $outlen, 0x1f, $raw_output);
    }
}
